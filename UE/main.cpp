...
int main(int argc, char* argv[])
{
    ...
    smsDb.addSMS(ue::SMS(PhoneNumber{123},phoneNumber,"1111111111111111111111111111111111111",false,SmsTransmissionState::initial));
    smsDb.addSMS(ue::SMS(PhoneNumber{123},phoneNumber,"2222222222222222222222222222222222222",false,SmsTransmissionState::initial));
